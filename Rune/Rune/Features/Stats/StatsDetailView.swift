...
struct StatsDetailView: View {
        ...
        ZStack {
            ...
            ScrollView {
                VStack(spacing: 16) {
                    ...
                    GlassCard {
                        VStack(spacing: 12) {
                            Text(RuneConfig.levelTitle(forXP: record?.totalXP ?? 0))
                    ...
                    GlassCard {
                        LazyVGrid(columns: [GridItem(.flexible()), GridItem(.flexible())], spacing: 16) {
                            ...
                            statCell("Daily Done", value: "\(record?.dailyScrollsCompleted ?? 0)")
    ...
    private func realmRow(_ realm: ScriptRealm) -> some View {
