...
final class SettingsRecord {
    ...
    init(soundEffects: Bool = true, haptics: Bool = true, currentTheme: String = "explorer",
         hasSeenOnboarding: Bool = false, highestUnlockedLevel: Int = 0, showTimer: Bool = true,
        ...
        self.showTimer = showTimer; self.dailyReminderEnabled = dailyReminderEnabled
