...
enum NotificationService {
    ...
    static func scheduleDailyReminder(hour: Int = 19, minute: Int = 0) {
        ...
        content.title = "Bloom"
        content.body = "Your garden is waiting. Plant something beautiful today."
    ...
    static func scheduleStreakReminder(currentStreak: Int) {
        ...
        let content = UNMutableNotificationContent()
        content.title = "Your garden needs you!"
        content.body = "Don't let your \(currentStreak)-day streak wilt. Plant today."
        content.sound = .default
