...
struct OnboardingView: View {
    ...
    private let pages: [(icon: String, title: String, subtitle: String)] = [
        ("heart.fill", "VITAL", "2-Minute Health Games"),
        ("eye.fill", "Eye Focus", "Train your visual focus\nwith moving targets"),
        ("wind", "Breath Sync", "Match the breathing rhythm\nfor calm and clarity"),
        ("bolt.fill", "Reflex Rush", "Test and improve\nyour reaction speed"),
    ]
    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 32) {
                ...
                GlassButton(page < pages.count - 1 ? "Next" : "Get Started!", icon: page < pages.count - 1 ? "arrow.right" : "heart.fill") {
