...
struct OnboardingView: View {
    ...
    private let pages: [(icon: String, title: String, desc: String)] = [
        ("atom", "Welcome to Aether", "Combine elements to discover new ones and unlock the secrets of alchemy."),
        ("flask.fill", "Experiment", "Start with the four classical elements and create hundreds of combinations."),
        ("star.fill", "Master the Realms", "Journey through five realms from Primordial to Cosmos."),
    ]
