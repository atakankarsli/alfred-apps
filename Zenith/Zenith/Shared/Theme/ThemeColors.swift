...
extension ThemeColors {
    init(
        background: String, surface: String, primary: String, secondary: String, accent: String,
        text: String, textSecondary: String, textMuted: String, textOnPrimary: String,
        cardBorder: String, cardBackground: String, cardHighlight: String, cardSelected: String,
