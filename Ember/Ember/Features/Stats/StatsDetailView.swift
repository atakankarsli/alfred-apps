...
struct StatsDetailView: View {
        ...
        ZStack {
            ...
            ScrollView {
                VStack(spacing: 16) {
                    ...
                    GlassCard {
                        VStack(spacing: 12) {
                            Text(EmberConfig.levelTitle(forXP: record?.totalXP ?? 0))
                    ...
                    GlassCard {
                        LazyVGrid(columns: [GridItem(.flexible()), GridItem(.flexible())], spacing: 16) {
                            ...
                            statCell("No Miss", value: "\(record?.noMissCount ?? 0)")
                            ...
                            statCell("Daily Done", value: "\(record?.dailyEmbersCompleted ?? 0)")
    ...
    private func realmRow(_ realm: FireRealm) -> some View {
